...
let PROJECTS = [
  ...
  },
  {
    ...
    year: '2023',
    size: 'project--sm',
    img: 'images/WhatsApp_Image_2026-06-01_at_12_48_35.jpeg',
  ...
  },
  {
    ...
    year: '2024',
    size: 'project--sm',
    img: 'images/ce673410-6cb1-4337-b20e-07c11b6db37e.png',
  ...
  {
    id: 'p7', cat: 'residential',
    title: 'Pandi Residence',
    location: 'Tamil Nadu',
    year: '2024',
    size: 'project--md',
    img: 'images/1d6282f4-df90-48ff-8d9d-7cf94a9904c8.png',
    tags: ['Residential', 'Villa'],
    desc: 'A contemporary residence blending bold form with refined materiality.',
    body: ['Pandi Residence is a modern family home designed for comfort and elegance.'],
    facts: { area: 'TBD', completion: '2024', team: 'AM Architects' },
  },
  {
    id: 'p8', cat: 'residential',
    title: 'VVG Villa',
    location: 'Tamil Nadu',
    year: '2024',
    size: 'project--md',
    img: 'images/c46a63f9-1d03-4fe4-ae73-0f63ec905e2d.png',
    tags: ['Residential', 'Villa'],
    desc: 'A sleek modern villa with clean lines and a dramatic double-height garage facade.',
    body: ['VVG Villa is a statement residence defined by its bold horizontal layers and warm timber accents.'],
    facts: { area: 'TBD', completion: '2024', team: 'AM Architects' },
  },
  {
    id: 'p9b', cat: 'residential',
    title: 'Aslam Residence',
    location: 'Tamil Nadu',
    year: '2024',
    size: 'project--md',
    img: 'images/dd90d9ba-665f-494c-89ef-b62b67d44a07.png',
    tags: ['Residential', 'Family Home'],
    desc: 'A refined contemporary home with layered balconies, warm lighting, and a strong street presence.',
    body: ['Aslam Residence occupies a corner site with a confident, well-proportioned facade.'],
    facts: { area: 'TBD', completion: '2024', team: 'AM Architects' },
  },
  {
    id: 'p10', cat: 'conceptual',
    title: 'Beach Resort',
    location: 'Coastal Tamil Nadu',
    year: '2025',
    size: 'project--lg',
    img: 'images/024828ba-0750-4973-819e-1a30a12f457d.png',
    tags: ['Conceptual', 'Resort', 'Hospitality'],
    desc: 'A beachfront resort concept with organic bamboo pavilions, a central pool, and coconut grove landscape.',
    body: [
      'The Beach Resort concept explores a low-impact hospitality model rooted in coastal ecology. Pavilions arranged around a central pool court, with organic bamboo shell roofs inspired by local boat-building tradition.',
      'The resort includes reception, dining, spa, and villa clusters — all connected by raised timber walkways through a restored coconut grove.',
    ],
    facts: { area: '2.5 acres', completion: 'Concept 2025', team: 'AM Architects' },
  },
  {
    id: 'p11', cat: 'conceptual',
    title: 'Meditation Hall — Shree Bairagi Vaishnava',
    location: 'Tamil Nadu',
    year: '2025',
    size: 'project--lg',
    img: 'images/a95bb6b4-13ee-49aa-838c-db76b22e4885.png',
    tags: ['Conceptual', 'Civic', 'Spiritual'],
    desc: 'A spiritual community hall — skylit galleries, contemplative courtyards, and a grand double-height meditation nave.',
    body: [
      'The Shree Bairagi Vaishnava Thulasi Baba Madam is conceived as a place of stillness at the centre of a busy township. Programme includes a main meditation hall, devotional art galleries, library, and community rooms.',
      'The facade is anchored by a dramatic curved parapet in textured terracotta plaster. Inside, a double-height nave is lit by a large ocular skylight.',
    ],
    facts: { area: '12,000 sq ft', completion: 'Concept 2025', team: 'AM Architects' },
  },
];
